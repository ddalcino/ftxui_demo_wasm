...
// configuration step. It creates a namespace called `ftxui_demo_wasm`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        ftxui_demo_wasm::cmake::project_name,
        ftxui_demo_wasm::cmake::project_version));// version string, acquired
